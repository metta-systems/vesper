...
| Frame/architecture | Frame kind encodable through the active Retype wrapper; Frame operation modules excluded | Frame creatable through the active Retype path (2026-09-15): architecture-validated sizes, kernel-sanitized carve; frame invocation unsupported | Inline region payload active; AArch64 granule sizes validated; mapping/invocation stubs |
