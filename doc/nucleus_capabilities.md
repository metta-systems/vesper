...
| Untyped / Buffer | Untyped Retype wrapper active (KeyTable and Frame kinds); Buffer excluded sketch | Retype handler active: transactional KeyTable/Frame carve; Buffer unsupported | Untyped inline region payload active; Buffer excluded sketch |
